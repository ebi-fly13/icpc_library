...
data:
  ...
  bundledCode: "#line 1 \"test/polynomial/Polynomial_Interpolation.test.cpp\"\n#define\
    ...
    \n\nnamespace lib {\n\ntemplate<class mint>\nstd::vector<mint> multipoint_evaluation(FormalPowerSeries<mint>\
    \ f, const std::vector<mint> &p) {\n    using FPS = FormalPowerSeries<mint>;\n\
    ...
    \n\n#line 7 \"test/polynomial/Polynomial_Interpolation.test.cpp\"\n\nnamespace\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/polynomial_interpolation\"\
    ...
    \nvoid main_() {\n    int n;\n    std::cin >> n;\n    std::vector<mint> x(n),\
    \ y(n);\n    rep(i,0,n) {\n        std::cin >> x[i].val();\n    }\n    rep(i,0,n)\
    \ {\n        std::cin >> y[i].val();\n    }\n    auto f = polynomial_interpolation<mint>(x,\
    \ y);\n    rep(i, 0, n) {\n        std::cout << f[i].val() << \" \\n\"[i == n\
    \ - 1];\n    }\n}\n\n}  // namespace ebi\n\nint main() {\n    int t = 1;\n   \
    \ // std::cin >> t;\n    while (t--) {\n        lib::main_();\n    }\n    return\
    \ 0;\n}"
